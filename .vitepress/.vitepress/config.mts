...
export default defineConfig({
  ...
  title: "ngx-template-engine",
  description: "A flexible and efficient template engine for dynamic content rendering. It enables easy integration of customizable templates within Angular applications.",
  themeConfig: {
    ...
    nav: [
      ...
      { text: packageJson.version, items: [
        { text: "Repository", link: "https://github.com/OGS-GmbH/ngx-template-engine" },
        { text: "Changelog", link: "https://github.com/OGS-GmbH/ngx-template-engine/blob/main/CHANGELOG.md" },
  ...
  base: "/ngx-template-engine/",
  srcDir: "../dist/vitepress-src",
  outDir: "../dist/docs",
  titleTemplate: ":title - OGS Template Engine",
  cleanUrls: true,
  appearance: true,
  markdown: {
